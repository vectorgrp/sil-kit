...
master_FrameStatusHandler(master, LinFrameStatusEvent{timeEndOfFrame, slave1Frame, FrameStatus::LIN_TX_OK});
//  - TX confirmation for slave1, who provided the frame response
slave1_FrameStatusHandler(slave1, LinFrameStatusEvent{timeEndOfFrame, slave1Frame, FrameStatus::LIN_TX_OK});
//  - RX for slave2, who received the frame response
slave2_FrameStatusHandler(slave2, LinFrameStatusEvent{timeEndOfFrame, slave1Frame, FrameStatus::LIN_RX_OK});
