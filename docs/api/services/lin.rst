...
.. literalinclude::
   /code-samples/lin/Master_to_Slave_LIN_TX_OK.cpp
   :language: cpp
...
.. literalinclude::
   /code-samples/lin/Slave_to_Master_LIN_RX_OK.cpp
   :language: cpp
...
.. literalinclude::
   /code-samples/lin/Slave_to_Slave_LIN_TX_OK.cpp
   :language: cpp
...
.. literalinclude::
   /code-samples/lin/Master_to_Slave_LIN_TX_ERROR.cpp
   :language: cpp
...
.. literalinclude::
   /code-samples/lin/Slave_to_Master_LIN_RX_NO_RESPONSE.cpp
   :language: cpp
...
.. literalinclude::
   /code-samples/lin/Slave_to_Master_LIN_RX_ERROR.cpp
   :language: cpp
...
.. literalinclude::
   /code-samples/lin/Go_To_Sleep.cpp
   :language: cpp
...
.. literalinclude::
   /code-samples/lin/LinSlaveConfigurationHandler.cpp
   :language: cpp
