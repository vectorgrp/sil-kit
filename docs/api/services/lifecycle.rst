...
* :cpp:func:`ICanController::Start()<SilKit::Services::Can::ICanController::Start>`
* :cpp:func:`ICanController::SetBaudRate()<SilKit::Services::Can::ICanController::SetBaudRate>`
* :cpp:func:`ILinController::Init()<SilKit::Services::Lin::ILinController::Init>`
* :cpp:func:`IEthernetController::Activate()<SilKit::Services::Ethernet::IEthernetController::Activate>`
* :cpp:func:`IFlexrayController::Configure()<SilKit::Services::Flexray::IFlexrayController::Configure>`
...
.. literalinclude:: 
	/code-samples/sync/LifecycleNoSyncSample.cpp
    :language: cpp
