...
The :ref:`participant configuration<sec:ibconfig-json>` is a YAML/JSON file which enables you to modify some aspects of the runtime behavior of SIL Kit simulation participants. 
