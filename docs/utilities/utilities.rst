...
The Registry is a mandatory part of the |ProductName| integrated middleware -- it is needed to establish the connections between simulation participants at the start of a simulation.
...
of the |ProductName| are free to implement their own system and state handling.
