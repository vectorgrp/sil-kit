...
const std::set<std::string> schemaPaths_v1 = {
    ...
    "/Experimental/TransmitQueueSize",
    "/Extensions",
    ...
    "/FlexRayControllers/NodeParameters/pWakeupPattern",
    "/FlexrayControllers/NodeParameters/pSecondKeySlotId",
    "/FlexRayControllers/NodeParameters/pSecondKeySlotId",
    "/FlexrayControllers/NodeParameters/pTwoKeySlotMode",
    "/FlexRayControllers/NodeParameters/pTwoKeySlotMode",
    ...
    "/Middleware/TcpNotSentLowWatermark",
