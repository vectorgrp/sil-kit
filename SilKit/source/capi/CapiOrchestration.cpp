...
try
{
    ...
    cppLifecycleService->SetCommunicationReadyHandler(
        [handler, context, lifecycleService]() { handler(context, lifecycleService); });
...
try
{
    ...
    cppLifecycleService->SetCommunicationReadyHandlerAsync(
        [handler, context, lifecycleService]() { handler(context, lifecycleService); });
...
try
{
    ...
    cppLifecycleService->SetStartingHandler(
        [handler, context, lifecycleService]() { handler(context, lifecycleService); });
...
SilKit_ReturnCode SilKitCALL SilKit_LifecycleService_SetStopHandler(SilKit_LifecycleService* clifecycleService,
                                                                    void* context,
...
try
{
    ...
    cppLifecycleService->SetStopHandler(
        [handler, context, clifecycleService]() { handler(context, clifecycleService); });
    return SilKit_ReturnCode_SUCCESS;
}
CAPI_CATCH_EXCEPTIONS
...
SilKit_ReturnCode SilKitCALL SilKit_LifecycleService_SetShutdownHandler(
    SilKit_LifecycleService* clifecycleService, void* context, SilKit_LifecycleService_ShutdownHandler_t handler)
try
{
    ASSERT_VALID_POINTER_PARAMETER(clifecycleService);
    ASSERT_VALID_HANDLER_PARAMETER(handler);
    ...
    cppLifecycleService->SetShutdownHandler(
        [handler, context, clifecycleService]() { handler(context, clifecycleService); });
    return SilKit_ReturnCode_SUCCESS;
}
CAPI_CATCH_EXCEPTIONS
...
try
{
    ...
    cppLifecycleService->SetAbortHandler(
        [handler, context, lifecycleService](SilKit::Services::Orchestration::ParticipantState cppParticipantState) {
...
SilKit_ReturnCode SilKitCALL SilKit_LifecycleService_WaitForLifecycleToComplete(
    SilKit_LifecycleService* clifecycleService, SilKit_ParticipantState* outParticipantState)
try
{
    ASSERT_VALID_POINTER_PARAMETER(clifecycleService);
...
try
{
    ...
    outParticipantStatus->enterTime = std::chrono::nanoseconds{participantStatus.enterTime.time_since_epoch()}.count();
...
try
{
    ...
    auto* lifeCycleService = reinterpret_cast<SilKit::Services::Orchestration::ILifecycleService*>(clifecycleService);
...
SilKit_ReturnCode SilKitCALL SilKit_SystemMonitor_GetSystemState(SilKit_SystemState* outParticipantState,
                                                                 SilKit_SystemMonitor* csystemMonitor)
try
{
    ASSERT_VALID_POINTER_PARAMETER(csystemMonitor);
...
SilKit_ReturnCode SilKitCALL SilKit_SystemMonitor_AddSystemStateHandler(SilKit_SystemMonitor* csystemMonitor,
                                                                        void* context,
...
SilKit_ReturnCode SilKitCALL SilKit_SystemMonitor_RemoveSystemStateHandler(SilKit_SystemMonitor* csystemMonitor,
...
SilKit_ReturnCode SilKitCALL SilKit_SystemMonitor_AddParticipantStatusHandler(SilKit_SystemMonitor* csystemMonitor,
                                                                              void* context,
...
try
{
    ...
    auto cppHandlerId = systemMonitor->AddParticipantStatusHandler(
        ...
        cStatus.enterTime =
            std::chrono::duration_cast<std::chrono::nanoseconds>(cppStatus.enterTime.time_since_epoch()).count();
        cStatus.participantName = cppStatus.participantName.c_str();
        cStatus.participantState = (SilKit_ParticipantState)cppStatus.state;
        cStatus.refreshTime =
            std::chrono::duration_cast<std::chrono::nanoseconds>(cppStatus.refreshTime.time_since_epoch()).count();
...
SilKit_ReturnCode SilKitCALL
SilKit_Experimental_SystemController_AbortSimulation(SilKit_Experimental_SystemController* cSystemController)
try
{
...
SilKit_ReturnCode SilKitCALL SilKit_Experimental_SystemController_SetWorkflowConfiguration(
    SilKit_Experimental_SystemController* cSystemController, const SilKit_WorkflowConfiguration* cWorkflowConfiguration)
try
{
    ASSERT_VALID_POINTER_PARAMETER(cSystemController);
