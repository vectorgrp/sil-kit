...
{
public:
    MOCK_METHOD(INetworkSimulator*, CreateNetworkSimulator, (), (override));
};
...
TEST_F(Test_CapiNetsim, netsim_nullpointer_params)
{
    ...
    returnCode = SilKit_Experimental_NetworkSimulator_SimulateNetwork(
        nullptr, networkName.c_str(), networkType, cMockSimulatedNetwork, &cSimulatedNetworkFunctions);
    EXPECT_EQ(returnCode, SilKit_ReturnCode_BADPARAMETER);
    returnCode = SilKit_Experimental_NetworkSimulator_SimulateNetwork(
        cMockNetworkSimulator, nullptr, networkType, cMockSimulatedNetwork, &cSimulatedNetworkFunctions);
    EXPECT_EQ(returnCode, SilKit_ReturnCode_BADPARAMETER);
    returnCode = SilKit_Experimental_NetworkSimulator_SimulateNetwork(
        cMockNetworkSimulator, networkName.c_str(), networkType, nullptr, &cSimulatedNetworkFunctions);
    EXPECT_EQ(returnCode, SilKit_ReturnCode_BADPARAMETER);
    returnCode = SilKit_Experimental_NetworkSimulator_SimulateNetwork(cMockNetworkSimulator, networkName.c_str(),
                                                                      networkType, cMockSimulatedNetwork, nullptr);
    EXPECT_EQ(returnCode, SilKit_ReturnCode_BADPARAMETER);
    ...
    EXPECT_EQ(returnCode, SilKit_ReturnCode_BADPARAMETER);
    returnCode =
        SilKit_Experimental_CanEventProducer_Produce(cMockCanEventProducer, &canFrameEvent.structHeader, nullptr);
    EXPECT_EQ(returnCode, SilKit_ReturnCode_BADPARAMETER);
    ...
    EXPECT_EQ(returnCode, SilKit_ReturnCode_BADPARAMETER);
    returnCode = SilKit_Experimental_EthernetEventProducer_Produce(cMockEthernetEventProducer,
                                                                   &ethFrameEvent.structHeader, nullptr);
    EXPECT_EQ(returnCode, SilKit_ReturnCode_BADPARAMETER);
    ...
    EXPECT_EQ(returnCode, SilKit_ReturnCode_BADPARAMETER);
    returnCode =
        SilKit_Experimental_LinEventProducer_Produce(cMockLinEventProducer, &linFrameStatusEvent.structHeader, nullptr);
    EXPECT_EQ(returnCode, SilKit_ReturnCode_BADPARAMETER);
    ...
    EXPECT_EQ(returnCode, SilKit_ReturnCode_BADPARAMETER);
    returnCode = SilKit_Experimental_FlexRayEventProducer_Produce(cMockFlexRayEventProducer,
                                                                  &flexrayFrameEvent.structHeader, nullptr);
    EXPECT_EQ(returnCode, SilKit_ReturnCode_BADPARAMETER);
}
...
TEST_F(Test_CapiNetsim, netsim_function_mapping)
{
    ...
    cMockNetworkSimulator =
        (SilKit_Experimental_NetworkSimulator*)&mockNetworkSimulator; // Recreate because the mocked SilKit_Experimental_NetworkSimulator_Create invalidated the pointer
    EXPECT_CALL(mockNetworkSimulator, SimulateNetwork(networkName, networkType, testing::_)).Times(testing::Exactly(1));
    returnCode = SilKit_Experimental_NetworkSimulator_SimulateNetwork(
        cMockNetworkSimulator, networkName.c_str(), cNetworkType, cMockSimulatedNetwork, &cSimulatedNetworkFunctions);
    EXPECT_EQ(returnCode, SilKit_ReturnCode_SUCCESS);
