...
void SilKitCALL FrameTransmitHandler(void* /*context*/, SilKit_CanController* /*controller*/,
                                     SilKit_CanFrameTransmitEvent* /*ack*/)
{
}

void SilKitCALL FrameHandler(void* /*context*/, SilKit_CanController* /*controller*/,
                             SilKit_CanFrameEvent* /*metaData*/)
{
}

void SilKitCALL StateChangeHandler(void* /*context*/, SilKit_CanController* /*controller*/,
                                   SilKit_CanStateChangeEvent* /*state*/)
{
}

void SilKitCALL ErrorStateChangeHandler(void* /*context*/, SilKit_CanController* /*controller*/,
                                        SilKit_CanErrorStateChangeEvent* /*state*/)
{
}
...
TEST_F(Test_CapiCan, can_controller_function_mapping)
{
    ...
    returnCode =
        SilKit_CanController_Create(&testParam, (SilKit_Participant*)&mockParticipant, "ControllerName", "NetworkName");
    ...
    returnCode = SilKit_CanController_AddFrameTransmitHandler((SilKit_CanController*)&mockController, NULL,
...
TEST_F(Test_CapiCan, can_controller_nullpointer_params)
{
    ...
    EXPECT_EQ(returnCode, SilKit_ReturnCode_BADPARAMETER);
    returnCode =
        SilKit_CanController_AddFrameTransmitHandler((SilKit_CanController*)&mockController, NULL,
                                                     &FrameTransmitHandler, SilKit_CanTransmitStatus_Canceled, nullptr);
    EXPECT_EQ(returnCode, SilKit_ReturnCode_BADPARAMETER);
