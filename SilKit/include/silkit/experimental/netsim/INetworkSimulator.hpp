...
/*! \brief API for simulated I2C controllers.
 *  If a new I2C controller is created on a simulated network, an implementation of this interface can be provided in \ref ISimulatedNetwork::ProvideSimulatedController.
 *  Messages generated by the original controller will be redirected to the simulated controller and trigger the On... callbacks.
 */
class ISimulatedI2cController : public ISimulatedController
{
public:
    virtual ~ISimulatedI2cController() = default;

    /*! \brief Incoming I2C controller message.
     *  Triggered when an I2C controller calls \ref SilKit::Services::I2c::II2cController::SendFrame.
     *  \param i2cFrameRequest The I2C frame requested to be sent.
     */
    virtual void OnFrameRequest(const I2cFrameRequest& i2cFrameRequest) = 0;

    /*! \brief Incoming I2C controller message.
     *  Triggered when an I2C controller calls \ref SilKit::Services::I2c::II2cController::Init.
     *  \param i2cControllerConfig The I2C controller configuration (mode, address, speed).
     */
    virtual void OnControllerConfig(const I2cControllerConfig& i2cControllerConfig) = 0;
};

//! Producer for I2C events.
//! Passed in \ref ISimulatedNetwork::SetEventProducer.
//! Messages can be produced for a given set of controllers, specified by a span of controller descriptors.
//! The individual controller descriptor of a remote controller is passed in \ref ISimulatedNetwork::ProvideSimulatedController.
class II2cEventProducer : public IEventProducer
{
public:
    virtual ~II2cEventProducer() = default;

    /*! \brief Produce a \ref SilKit::Services::I2c::I2cFrameEvent for a given set of receivers on this network.
     *  \param frameEvent The produced I2C frame event.
     *  \param receivers The recipients of the event as a span of controller descriptors.
     */
    virtual void Produce(const SilKit::Services::I2c::I2cFrameEvent& frameEvent,
                         const SilKit::Util::Span<const ControllerDescriptor>& receivers) = 0;

    /*! \brief Produce a \ref SilKit::Services::I2c::I2cFrameTransmitEvent for a given set of receivers on this network.
     *  \param frameTransmitEvent The produced I2C transmit acknowledge event.
     *  \param receivers The recipients of the event as a span of controller descriptors.
     */
    virtual void Produce(const SilKit::Services::I2c::I2cFrameTransmitEvent& frameTransmitEvent,
                         const SilKit::Util::Span<const ControllerDescriptor>& receivers) = 0;
};
