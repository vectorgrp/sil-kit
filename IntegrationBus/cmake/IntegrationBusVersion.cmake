...
macro(configure_ib_version project_name)
    ...
    set(IB_VERSION_MINOR 99)
    set(IB_VERSION_PATCH 26)
    set(IB_BUILD_NUMBER 0 CACHE STRING "The build number")
    set(IB_VERSION_SUFFIX "")

    set(VERSION_STRING "${IB_VERSION_MAJOR}.${IB_VERSION_MINOR}.${IB_VERSION_PATCH}")
    if (IB_VERSION_SUFFIX)
        set(VERSION_STRING "${VERSION_STRING}-${IB_VERSION_SUFFIX}")
    endif()
