...
public:
    ...
    virtual auto SendMessage(EthMessage msg) -> EthTxId = 0;
     ...
     /*! Overload of \ref SendMessage(EthMessage) with additional timestamp for
     * the reception time of a Ethernet transmission.
     *
     * \param timestamp This time stamp value is encoded in the
     * EthMessage data. When using the VIBE NetworkSimulator,
     * precise timestamps are always generated by the NetworkSimulator.
     */
    virtual auto SendMessage(EthMessage msg, std::chrono::nanoseconds timestamp) -> EthTxId = 0;
