...
typedef struct ib_CanMessage ib_CanMessage;
...
typedef struct ib_CanController ib_CanController;
...
*/
typedef void ib_CanTransmitStatusHandler_t(void* context, ib_CanController* controller, 
    ib_CanTransmitAcknowledge* acknowledge);
...
*/
typedef void ib_CanReceiveMessageHandler_t(void* context, ib_CanController* controller, 
    ib_CanMessage* metaData);
...
*/
typedef void ib_CanStateChangedHandler_t(void* context, ib_CanController* controller, 
    ib_CanControllerState state);
...
*/
typedef void ib_CanErrorStateChangedHandler_t(void* context, ib_CanController* controller, 
    ib_CanErrorState errorState);
...
typedef ib_ReturnCode (*ib_CanController_SendFrame_t)(ib_CanController* self, ib_CanFrame* frame, 
    void* userContext);
...
*/
CIntegrationBusAPI ib_ReturnCode ib_CanController_SetBaudRate(ib_CanController* self, uint32_t rate, 
    uint32_t fdRate);

typedef ib_ReturnCode (*ib_CanController_RegisterTransmitStatusHandler_t)(ib_CanController* self, void* context, 
    ib_CanTransmitStatusHandler_t* handler);
...
*/
CIntegrationBusAPI ib_ReturnCode ib_CanController_RegisterTransmitStatusHandler(ib_CanController* self, 
    void* context, ib_CanTransmitStatusHandler_t* handler);

typedef ib_ReturnCode (*ib_CanController_RegisterReceiveMessageHandler_t)(ib_CanController* self, void* context, 
    ib_CanReceiveMessageHandler_t* handler);
...
*/
CIntegrationBusAPI ib_ReturnCode ib_CanController_RegisterReceiveMessageHandler(ib_CanController* self, 
    void* context, ib_CanReceiveMessageHandler_t* handler);
    
typedef ib_ReturnCode (*ib_CanController_RegisterStateChangedHandler_t)(ib_CanController* self, void* context, 
    ib_CanStateChangedHandler_t* handler);
...
*/
CIntegrationBusAPI ib_ReturnCode ib_CanController_RegisterStateChangedHandler(ib_CanController* self, 
    void* context, ib_CanStateChangedHandler_t* handler);
    
typedef ib_ReturnCode (*ib_CanController_RegisterErrorStateChangedHandler_t)(ib_CanController* self, 
    void* context, ib_CanErrorStateChangedHandler_t* handler);
...
*/
CIntegrationBusAPI ib_ReturnCode ib_CanController_RegisterErrorStateChangedHandler(ib_CanController* self, 
    void* context, ib_CanErrorStateChangedHandler_t* handler);
