...
/*! \brief The ib_Data_ExchangeFormat provides meta information to data of the data exchange service.
*   Except for this descriptive purpose, it is used for matching DataProviders and DataSubscribers.
*/
typedef struct {
...
*/
typedef void (*ib_Data_Handler_t)(void* context, ib_Data_Subscriber* subscriber, 
    const ib_ByteVector* data);

/*! \brief Handler type for new data sources.
* \param context The context that the user provided on registration.
* \param subscriber The affected subscriber.
* \param dataExchangeFormat The meta description of the data used by the new source.
...
typedef void (*ib_Data_NewDataSourceHandler_t)(void* context, ib_Data_Subscriber* subscriber, const char* topic,
                                          const ib_Data_ExchangeFormat* dataExchangeFormat,
...
ib_Data_Subscriber_Create(ib_Data_Subscriber** outSubscriber, ib_SimulationParticipant* participant, const char* topic,
                          ib_Data_ExchangeFormat* dataExchangeFormat, const ib_KeyValueList* labels,
...
* \param dataExchangeFormat The meta description of the data that has to match the dataExchangeFormat of the 
* DataPublisher to use the specific handler.
...
IntegrationBusAPI ib_ReturnCode ib_Data_Subscriber_RegisterSpecificDataHandler(
    ib_Data_Subscriber* self, ib_Data_ExchangeFormat* dataExchangeFormat, const ib_KeyValueList* labels, void* context,
    ib_Data_Handler_t dataHandler);
