 ...
 *  Cf., \ref ib_Lin_Controller_RegisterGoToSleepHandler();
 */
...
/*! \brief AUTOSAR LIN master interface
 *
 * Overload to \ref ib_Lin_Controller_SendFrame(ib_Lin_Controller* controller, ib_Lin_Frame frame, ib_Lin_FrameResponseType
 ...
 * ib_Lin_FrameStatusHandler_t unless a VIBE NetworkSimulator is used. When using
 * VIBE NetworkSimulator, precise timestamps are always generated by the
 * NetworkSimulator.
 */
IntegrationBusAPI ib_ReturnCode ib_Lin_Controller_SendFrameWithTimestamp(ib_Lin_Controller* controller, const ib_Lin_Frame* frame,
                                                                         ib_Lin_FrameResponseType responseType,
...
/*! Send Interface for a non-AUTOSAR Lin Master
 *
 * Overload to \ref ib_Lin_Controller_SendFrameHeader(ib_Lin_Controller* controller, ib_Lin_Id linId) with additional timestamp
 ...
 * NetworkSimulator.
 */
IntegrationBusAPI ib_ReturnCode ib_Lin_Controller_SendFrameHeaderWithTimestamp(ib_Lin_Controller* controller, ib_Lin_Id linId,
                                                                  ib_NanosecondsTime timestamp);
...
IntegrationBusAPI ib_ReturnCode ib_Lin_Controller_SetFrameResponse(ib_Lin_Controller* controller, const ib_Lin_Frame* frame,
 ...
 */
IntegrationBusAPI ib_ReturnCode ib_Lin_Controller_RegisterFrameStatusHandler(ib_Lin_Controller* controller, void* context,
 ...
 */
IntegrationBusAPI ib_ReturnCode ib_Lin_Controller_RegisterGoToSleepHandler(ib_Lin_Controller* controller, void* context,
 ...
 */
IntegrationBusAPI ib_ReturnCode ib_Lin_Controller_RegisterWakeupHandler(ib_Lin_Controller* controller, void* context,
