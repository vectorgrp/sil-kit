...
enum class SyncType
{
    ...
    Unsynchronized,          //!< The participant does not participate in time synchronization and does not publish a participant state.
    Synchronized             //!< The participant participates in time synchronization and does publish a participant state.
};
