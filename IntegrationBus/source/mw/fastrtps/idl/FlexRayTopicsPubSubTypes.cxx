    ...
    namespace sim
    {
        namespace fr
        {
            namespace idl
            {
                ...
                TxBufferConfigUpdatePubSubType::TxBufferConfigUpdatePubSubType()
                {
                    setName("ib::sim::fr::idl::TxBufferConfigUpdate");
                    m_typeSize = static_cast<uint32_t>(TxBufferConfigUpdate::getMaxCdrSerializedSize()) + 4 /*encapsulation*/;
                    m_isGetKeyDefined = TxBufferConfigUpdate::isKeyDefined();
                    size_t keyLength = TxBufferConfigUpdate::getKeyMaxCdrSerializedSize()>16 ? TxBufferConfigUpdate::getKeyMaxCdrSerializedSize() : 16;
                    m_keyBuffer = reinterpret_cast<unsigned char*>(malloc(keyLength));
                    memset(m_keyBuffer, 0, keyLength);
                }
                ...
                bool TxBufferConfigUpdatePubSubType::serialize(void *data, SerializedPayload_t *payload)
                {
                    TxBufferConfigUpdate *p_type = static_cast<TxBufferConfigUpdate*>(data);
                    eprosima::fastcdr::FastBuffer fastbuffer(reinterpret_cast<char*>(payload->data), payload->max_size); // Object that manages the raw buffer.
                    eprosima::fastcdr::Cdr ser(fastbuffer, eprosima::fastcdr::Cdr::DEFAULT_ENDIAN,
                            eprosima::fastcdr::Cdr::DDS_CDR); // Object that serializes the data.
                    payload->encapsulation = ser.endianness() == eprosima::fastcdr::Cdr::BIG_ENDIANNESS ? CDR_BE : CDR_LE;
                ...
                bool TxBufferConfigUpdatePubSubType::deserialize(SerializedPayload_t* payload, void* data)
                {
                    TxBufferConfigUpdate* p_type = static_cast<TxBufferConfigUpdate*>(data); //Convert DATA to pointer of your type
                    eprosima::fastcdr::FastBuffer fastbuffer(reinterpret_cast<char*>(payload->data), payload->length); // Object that manages the raw buffer.
                    eprosima::fastcdr::Cdr deser(fastbuffer, eprosima::fastcdr::Cdr::DEFAULT_ENDIAN,
                            eprosima::fastcdr::Cdr::DDS_CDR); // Object that deserializes the data.
                    // Deserialize encapsulation.
                ...
                std::function<uint32_t()> TxBufferConfigUpdatePubSubType::getSerializedSizeProvider(void* data)
                {
                    return [data]() -> uint32_t
                    {
                        return static_cast<uint32_t>(type::getCdrSerializedSize(*static_cast<TxBufferConfigUpdate*>(data))) + 4 /*encapsulation*/;
                    };
                }

                void* TxBufferConfigUpdatePubSubType::createData()
                {
                    return reinterpret_cast<void*>(new TxBufferConfigUpdate());
                }

                void TxBufferConfigUpdatePubSubType::deleteData(void* data)
                {
                    delete(reinterpret_cast<TxBufferConfigUpdate*>(data));
                }

                bool TxBufferConfigUpdatePubSubType::getKey(void *data, InstanceHandle_t* handle, bool force_md5)
                {
                    if(!m_isGetKeyDefined)
                        return false;
                    TxBufferConfigUpdate* p_type = static_cast<TxBufferConfigUpdate*>(data);
                    eprosima::fastcdr::FastBuffer fastbuffer(reinterpret_cast<char*>(m_keyBuffer),TxBufferConfigUpdate::getKeyMaxCdrSerializedSize());     // Object that manages the raw buffer.
                    eprosima::fastcdr::Cdr ser(fastbuffer, eprosima::fastcdr::Cdr::BIG_ENDIANNESS);     // Object that serializes the data.
                    p_type->serializeKey(ser);
                    if(force_md5 || TxBufferConfigUpdate::getKeyMaxCdrSerializedSize()>16)    {
                        m_md5.init();
                        m_md5.update(m_keyBuffer, static_cast<unsigned int>(ser.getSerializedDataLength()));
                        m_md5.finalize();
                        for(uint8_t i = 0;i<16;++i)        {
                ...
                CycleStartPubSubType::CycleStartPubSubType()
                {
                    setName("ib::sim::fr::idl::CycleStart");
                    m_typeSize = static_cast<uint32_t>(CycleStart::getMaxCdrSerializedSize()) + 4 /*encapsulation*/;
                    m_isGetKeyDefined = CycleStart::isKeyDefined();
                    size_t keyLength = CycleStart::getKeyMaxCdrSerializedSize()>16 ? CycleStart::getKeyMaxCdrSerializedSize() : 16;
                    m_keyBuffer = reinterpret_cast<unsigned char*>(malloc(keyLength));
                    memset(m_keyBuffer, 0, keyLength);
                }
                ...
                bool CycleStartPubSubType::serialize(void *data, SerializedPayload_t *payload)
                {
                    CycleStart *p_type = static_cast<CycleStart*>(data);
                    eprosima::fastcdr::FastBuffer fastbuffer(reinterpret_cast<char*>(payload->data), payload->max_size); // Object that manages the raw buffer.
                    eprosima::fastcdr::Cdr ser(fastbuffer, eprosima::fastcdr::Cdr::DEFAULT_ENDIAN,
                            eprosima::fastcdr::Cdr::DDS_CDR); // Object that serializes the data.
                    payload->encapsulation = ser.endianness() == eprosima::fastcdr::Cdr::BIG_ENDIANNESS ? CDR_BE : CDR_LE;
                ...
                bool CycleStartPubSubType::deserialize(SerializedPayload_t* payload, void* data)
                {
                    CycleStart* p_type = static_cast<CycleStart*>(data); //Convert DATA to pointer of your type
                    eprosima::fastcdr::FastBuffer fastbuffer(reinterpret_cast<char*>(payload->data), payload->length); // Object that manages the raw buffer.
                    eprosima::fastcdr::Cdr deser(fastbuffer, eprosima::fastcdr::Cdr::DEFAULT_ENDIAN,
                            eprosima::fastcdr::Cdr::DDS_CDR); // Object that deserializes the data.
                    // Deserialize encapsulation.
                ...
                std::function<uint32_t()> CycleStartPubSubType::getSerializedSizeProvider(void* data)
                {
                    return [data]() -> uint32_t
                    {
                        return static_cast<uint32_t>(type::getCdrSerializedSize(*static_cast<CycleStart*>(data))) + 4 /*encapsulation*/;
                    };
                }

                void* CycleStartPubSubType::createData()
                {
                    return reinterpret_cast<void*>(new CycleStart());
                }

                void CycleStartPubSubType::deleteData(void* data)
                {
                    delete(reinterpret_cast<CycleStart*>(data));
                }

                bool CycleStartPubSubType::getKey(void *data, InstanceHandle_t* handle, bool force_md5)
                {
                    if(!m_isGetKeyDefined)
                        return false;
                    CycleStart* p_type = static_cast<CycleStart*>(data);
                    eprosima::fastcdr::FastBuffer fastbuffer(reinterpret_cast<char*>(m_keyBuffer),CycleStart::getKeyMaxCdrSerializedSize());     // Object that manages the raw buffer.
                    eprosima::fastcdr::Cdr ser(fastbuffer, eprosima::fastcdr::Cdr::BIG_ENDIANNESS);     // Object that serializes the data.
                    p_type->serializeKey(ser);
                    if(force_md5 || CycleStart::getKeyMaxCdrSerializedSize()>16)    {
                        m_md5.init();
                        m_md5.update(m_keyBuffer, static_cast<unsigned int>(ser.getSerializedDataLength()));
                        m_md5.finalize();
                        for(uint8_t i = 0;i<16;++i)        {
                ...
                PocStatusPubSubType::PocStatusPubSubType()
                {
                    setName("ib::sim::fr::idl::PocStatus");
                    m_typeSize = static_cast<uint32_t>(PocStatus::getMaxCdrSerializedSize()) + 4 /*encapsulation*/;
                    m_isGetKeyDefined = PocStatus::isKeyDefined();
                    size_t keyLength = PocStatus::getKeyMaxCdrSerializedSize()>16 ? PocStatus::getKeyMaxCdrSerializedSize() : 16;
                    m_keyBuffer = reinterpret_cast<unsigned char*>(malloc(keyLength));
                    memset(m_keyBuffer, 0, keyLength);
                }
                ...
                bool PocStatusPubSubType::serialize(void *data, SerializedPayload_t *payload)
                {
                    PocStatus *p_type = static_cast<PocStatus*>(data);
                    eprosima::fastcdr::FastBuffer fastbuffer(reinterpret_cast<char*>(payload->data), payload->max_size); // Object that manages the raw buffer.
                    eprosima::fastcdr::Cdr ser(fastbuffer, eprosima::fastcdr::Cdr::DEFAULT_ENDIAN,
                            eprosima::fastcdr::Cdr::DDS_CDR); // Object that serializes the data.
                    payload->encapsulation = ser.endianness() == eprosima::fastcdr::Cdr::BIG_ENDIANNESS ? CDR_BE : CDR_LE;
                ...
                bool PocStatusPubSubType::deserialize(SerializedPayload_t* payload, void* data)
                {
                    PocStatus* p_type = static_cast<PocStatus*>(data); //Convert DATA to pointer of your type
                    eprosima::fastcdr::FastBuffer fastbuffer(reinterpret_cast<char*>(payload->data), payload->length); // Object that manages the raw buffer.
                    eprosima::fastcdr::Cdr deser(fastbuffer, eprosima::fastcdr::Cdr::DEFAULT_ENDIAN,
                            eprosima::fastcdr::Cdr::DDS_CDR); // Object that deserializes the data.
                    // Deserialize encapsulation.
                ...
                std::function<uint32_t()> PocStatusPubSubType::getSerializedSizeProvider(void* data)
                {
                    return [data]() -> uint32_t
                    {
                        return static_cast<uint32_t>(type::getCdrSerializedSize(*static_cast<PocStatus*>(data))) + 4 /*encapsulation*/;
                    };
                }

                void* PocStatusPubSubType::createData()
                {
                    return reinterpret_cast<void*>(new PocStatus());
                }

                void PocStatusPubSubType::deleteData(void* data)
                {
                    delete(reinterpret_cast<PocStatus*>(data));
                }

                bool PocStatusPubSubType::getKey(void *data, InstanceHandle_t* handle, bool force_md5)
                {
                    if(!m_isGetKeyDefined)
                        return false;
                    PocStatus* p_type = static_cast<PocStatus*>(data);
                    eprosima::fastcdr::FastBuffer fastbuffer(reinterpret_cast<char*>(m_keyBuffer),PocStatus::getKeyMaxCdrSerializedSize());     // Object that manages the raw buffer.
                    eprosima::fastcdr::Cdr ser(fastbuffer, eprosima::fastcdr::Cdr::BIG_ENDIANNESS);     // Object that serializes the data.
                    p_type->serializeKey(ser);
                    if(force_md5 || PocStatus::getKeyMaxCdrSerializedSize()>16)    {
                        m_md5.init();
                        m_md5.update(m_keyBuffer, static_cast<unsigned int>(ser.getSerializedDataLength()));
                        m_md5.finalize();
                        for(uint8_t i = 0;i<16;++i)        {
